...
public class MainMenu extends JLayeredPane {
    ...
    public MainMenu(GameWindow gameWindow) {
        ...
        playBackgroundMusic("src/main/resources/sounds/soundtrack/MYRONE_Exclusive_Coupe.wav");
        
        JPanel buttonPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 20, 20));
        buttonPanel.setBackground(new Color(0, 0, 0, 0));
        buttonPanel.setOpaque(false); 

        JButton newGameButton = createImageButton("src/main/resources/textures/new_game.png", "Новая игра");
        JButton viewResultsButton = createImageButton("src/main/resources/textures/records.png", "Просмотр результатов");
        JButton exitButton = createImageButton("src/main/resources/textures/exit.png", "Выход");
        JButton editTrackButton = createImageButton("src/main/resources/textures/level_edit.png", "Редактор трасс");
        JButton shopButton = createImageButton("src/main/resources/textures/shop.png", "shop");
        ...
        // Создание кнопки FAQ
        JButton faqButton = createImageButton("src/main/resources/textures/faq_icon.png", "faq");
    ...
    private JButton createFAQButton() {
        ...
        faqButton.setIcon(new ImageIcon("src/main/resources/textures/faq_icon.png"));
    ...
    private void showFAQ() {
        ...
        JLabel label = new JLabel(new ImageIcon("src/main/resources/textures/faq.png"));
        faqFrame.add(label);
    ...
    private JButton createImageButton(String imagePath, String actionCommand) {
        ...
        button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                playSound("src/main/resources/sounds/soundtrack/button_pick.wav");
            }
    ...
    private void showTrackSelection() {
        File trackDir = new File("src/main/resources/tracks");
    ...
    private class BackgroundPanel extends JPanel {
       ...
       public BackgroundPanel() {
           backgroundImage = Toolkit.getDefaultToolkit().getImage("src/main/resources/textures/background.png");
           setLayout(new BorderLayout());
           setOpaque(false);
       }
